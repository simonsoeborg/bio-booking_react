...
import Movies from '../Assets/DTO/getMovie'
...
export default function MoviePage() {
    ...
    if (id === undefined) {
        ...
        return (
            <LoadedMoviePage id={id} />
        )
    }
}

async function LoadedMoviePage( {id} ) {
    let movie = Movies.getMovie(id);
    console.log( movie )
    console.log(Movies.getMovie(id));
