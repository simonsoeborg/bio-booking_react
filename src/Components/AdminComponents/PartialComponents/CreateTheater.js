      ...
      <Container>
              ...
              <Form>
                ...
                <div className="text-center">
                  <Button
                    ...
                    style={{ margin: '1rem'}}
                    onClick={() => onFormSubmit(JSON.stringify(ts.Theater))}
                  >
                    Opret
                  </Button>
                </div>
        ...
        <Modal show={showModal} onHide={handleOnClose}>
          <Modal.Header closeButton>
            ...
            { success ? <Modal.Body>Der gik noget galt, da vi prøvede at oprette: { ts.Theater.theaterName } </Modal.Body> : <Modal.Body>{ ts.Theater.theaterName } er nu oprettet! </Modal.Body>}
          <Modal.Footer>
...
export default observer(CreateTheater);
