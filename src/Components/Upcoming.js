...
const UpcomingMovies = () => {
    ...
    if (!ms.Movies || ms.Movies.length === 0) {
        ...
        <Container>
            <Row> 
                <h1>Disse film bliver snart vidst i Bio 404!</h1>
            </Row>
            ...
            <Row className="justify-content-md-center">
                <Container style={{ width: '15rem'}}>
                    <Button variant="outline-success" onClick={() => routeChange(9999)}>Vis kørende film</Button>
                </Container>
            </Row>
        </Container>
        )
...
export default observer(UpcomingMovies);